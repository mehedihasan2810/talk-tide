...
const MockMessageItems = () => {
  return (
    <div
      aria-hidden={true}
      className="absolute inset-0 -z-[9] mx-auto max-w-[1920px]"
    >
      {/* top left messages */}
      ...
      <div className="absolute left-[10%] top-[18%] mt-1 flex items-end gap-1 sm:mt-0 lg:left-[15%] lg:top-[20%] xl:left-[20%]">
